<template>
    <div id="LandingAgency" class="row">
        <div class="left col-md-6 overlay" @click="hide()"></div>
        <div class="right col-md-6" v-if="loading || !vendor">
            <div class="section-loader">
                <img src="/loader-circle.gif" alt="">
                <span>{{$t('Loading')}}</span>
            </div>
        </div>
        <div class="right col-md-6" v-else-if="vendor">
            ...
            <div id="body_content" v-if="!opting_for">
                ...
                <div class="body" v-if="active_tab=='about'">
                    ...
                    <div class="row row_data working_days">
                        ...
                        <div class="col-md-10 info">
                            <span style="margin-top: 20px;">{{vendor.address}}</span>
                        </div>
                    </div>
                    <br>
                    <br>
