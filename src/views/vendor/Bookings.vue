<template>
    <div id="LandingBookings" class="row" v-if="Vendor">
        ...
        <div id="Step1" class="m-0 p-0 col-md-12" v-if="step==1">
            <div class="header row w-100" v-if="selected.show_dep_and_members">
                ...
                <div class="col-md-6 members" v-if="selected.department && selected.department.members && selected.department.dep_members.length > 0">
                    <label for="member">
        ...
        <div id="Step2" class="w-100 m-0 p-0" v-else-if="step==2">
            ...
            <div v-else>
                <div class="calendar text-center row m-0 p-0">
    ...
    methods:{
        ...
        specifyBookingDays(){
            ...
            this.Vendor.holidays.map((obj)=>{
                if(obj.member_id==null || obj.member==null || ( this.selected.member && obj.member_id==this.selected.member.id) ){
                    let range = {}
...
<style lang="scss">
    ...
    .day-header, .day__month_btn, .month__year_btn{
        font-weight: bold;
        color: var(--primary);
    }
    .cell:hover{
